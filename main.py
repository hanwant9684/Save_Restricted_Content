...
if __name__ == "__main__":
    ...
    async def main():
        ...
        try:
            ...
            # Register promo management commands for admins
            from admin_commands import (
                create_promo_command, list_promos_command, delete_promo_command
            )
            
            bot.add_event_handler(create_promo_command, events.NewMessage(pattern='/createpromo'))
            bot.add_event_handler(list_promos_command, events.NewMessage(pattern='/listpromos'))
            bot.add_event_handler(delete_promo_command, events.NewMessage(pattern='/deletepromo'))
